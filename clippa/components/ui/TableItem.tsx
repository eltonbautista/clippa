...
export default function TableItem({ id, fileName, status, created, deleteUpload, children }:
  { id: string; fileName: string; status: string; created: string; deleteUpload: (id: string) => void; children: React.ReactNode }) {
    ...
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
        <div className="flex items-center gap-3">
          ...
          <button className="text-gray-400 hover:text-gray-600" onClick={() => deleteUpload(id)}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
